    ...
    return (
        <div id="about-page">
            ...
            <div id="about-page-text-div">
                ...
                <p className="text-about-me">Before I started studying I used to work part time as a hotel receptionist at nights and the rest of the time I used to carpentry and renovate shabby apartments.</p>
                <div id="last-part-about">
                    <p className="text-about-me">So with my experience you can say that I can use both my hands, brain and handle all kinds of people. All in one!</p>
                </div>
