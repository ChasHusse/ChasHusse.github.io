...
export default function ContactPage() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_rp4dot8', 'template_n3y7hgi', form.current, 'Zvlr5S7soz3Zcuwpz')
            .then((result) => {
            ...
            <div id="contact-information">
                <form ref={form} onSubmit={sendEmail}>
                    ...
                    <textarea
                        ...
                        required
                    ></textarea>
                    <input className="btn ac_btn" type="submit" value="Send" />
                </form>
                <div id="right-side-contact">
                    <div className="email-box">
                        ...
                        <p>hussein.yousif@chasacademy.se</p>
